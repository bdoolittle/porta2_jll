...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import porta2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("259e7601-86d0-5adc-ab28-cddeb12e238c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "porta2", artifacts_toml) for e in artifacts["porta2"]]
...
if best_platform === nothing
    @debug("Unable to load porta2; unsupported platform $(triplet(platform_key_abi()))")
else
